				...
				<div class="col-md-12">
					<div class="panel panel-default">
					  <div class="panel-body">
					     ...
					     <p>医生：<a href="doctors?departmentId=${order.workArrangement.doctor.department.did}#doctor-${order.workArrangement.doctor.docId}">${order.workArrangement.doctor.name}</a></p>
